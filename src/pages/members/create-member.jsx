...
// project imports
import { CreateMemberPage } from 'components/PageComponents';
...
const CreateMember = () => {
  ...
  return <CreateMemberPage memberData={memberData?.data} projectData={projectData?.data} roleData={roleData?.data} />;
};
